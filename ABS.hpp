...
public:
    ...
    ABS() : capacity_(1), curr_size_(0), array_() {}
    // Parameterized Constructor. Same behavior as default, however set capacity_ to capacity
    explicit ABS(const size_t capacity) : capacity_(capacity), curr_size_(0), array_() {}
    // Copy constructor
    ...
    [[nodiscard]] LinkedList<T> getData() const noexcept { return array_; } // Need to return T* instead?
    ...
    T peek() const override {
        ...
        return array_.getHead()->next->data;
    }
